...
(function(global,undefined){"use strict";(function prelude(modules, cache, entries) {
    ...
    // This is the prelude used to bundle protobuf.font for the browser. Wraps up the CommonJS
 ...
 * @example
 * // pbjs -r myroot -o compiled.font ...
 *
 * // in another module:
 * require("./compiled.font");
 *
 ...
 *
 * This is a minimal stand-alone definition of a Long instance. The actual type is that exported by long.font.
 * @typedef Long
 * @type {Object}
...
/**
 * Long.font's Long class if available.
...
function writeStringBuffer(val, buf, pos) {
    if (val.length < 40) // plain font is faster for short strings (probably due to redundant assertions)
...
//# sourceMappingURL=protobuf.font.map
